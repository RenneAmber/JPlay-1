                        ...
                        <div class="logIn">
                            ...
                            <div id="login-user-name">
                                ...
                                <input required autofocus type="text" style="width:80%"
                                       name="email" ng-model="email" placeholder="用户名/邮箱/已验证手机" id="email"/>
                            ...
                            <button type="submit" onsubmit="javascript:encryptionPassword()" style="font-size: 20px;height:40px;background-color:#d58512;border: none;
